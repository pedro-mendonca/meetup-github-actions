...
if ( ! class_exists( __NAMESPACE__ . '\Init' ) ) {
	...
	class Init {
		...
		public static function admin_menu() {
			...
			// Icon.
			$svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 367.4 90" class="footer-logo-mktg d-block" height="30">
				<g fill="currentColor">
			...
			add_menu_page(
				esc_html__( 'Meetup Github Actions', 'meetup-github-actions' ), // Page title.
				esc_html__( 'Meetup Github Actions', 'meetup-github-actions' ), // Menu title.
