...
if ( ! class_exists( Init::class ) ) {
	...
	class Init {
		...
		public static function admin_menu() {
			...
			add_menu_page(
				esc_html__( 'GitHub Actions', 'meetup-github-actions' ),   // Page title.
				esc_html__( 'GitHub Actions', 'meetup-github-actions' ),   // Menu title.
				'read',                                                    // Capability required to access this menu item.
				'https://github.com/pedro-mendonca/meetup-github-actions', // URL.
				'',                                                        // Callback.
				$menu_icon,                                                // Menu icon.
				3                                                          // Menu position.
			);
